...
private slots:
    ...
    void save_and_load_string()
    {
        ...
        QCOMPARE(s.Load(QStringLiteral("lang"), QStringLiteral("")), QStringLiteral("de"));
    }
    ...
    void mru_group_round_trip()
    {
        ...
        QCOMPARE(r.value(QStringLiteral("0")).toString(), QStringLiteral("/tmp/a.dbw"));
        QCOMPARE(r.value(QStringLiteral("1")).toString(), QStringLiteral("/tmp/b.dbw"));
