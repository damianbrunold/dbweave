    ...
    : QDialog(_parent)
{
    ...
    auto* title
        = new QLabel(QStringLiteral("<h2>DB-WEAVE %1</h2>"
    ...
    auto* colLeft
        = new QLabel(QStringLiteral("<h3>What DB-WEAVE is</h3>"
    ...
    auto* colRight
        = new QLabel(QStringLiteral("<p>In any case, we recommend to explore the program's "
    ...
    QPushButton* techBtn
        = btns->addButton(QStringLiteral("&Technical Info..."), QDialogButtonBox::ActionRole);
