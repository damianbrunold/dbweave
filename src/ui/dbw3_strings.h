...
/*  Port note: the legacy file is ISO-8859-1 encoded. This port is
    UTF-8. German umlauts have been transcoded -- text content
    otherwise matches the legacy dbw3_strings.h byte for byte. */

/*-----------------------------------------------------------------*/
#ifndef DBWEAVE_UI_DBW3_STRINGS_H
#define DBWEAVE_UI_DBW3_STRINGS_H
/*-----------------------------------------------------------------*/
#include "language.h"
/*-----------------------------------------------------------------*/
...
#define WEB_KLAMMER1 LANG_STR("  Brace ", "  Klammer ").toLocal8Bit().constData()
#define WEB_REPEAT LANG_STR("  Repetition ", "  Wiederholung ").toLocal8Bit().constData()
#define WEB_KL_LENGTH LANG_STR("  Length ", "  Länge ").toLocal8Bit().constData()
