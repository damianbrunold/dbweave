...
{
public:
    PreviewCanvas(const QImage& _bmp, QSpinBox* _res, int _used, const QRgb* _colors,
    ...
    : QDialog(_parent)
{
    ...
    connect(spinRes, qOverload<int>(&QSpinBox::valueChanged), preview,
