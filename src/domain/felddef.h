...
/*  Pure-domain container primitives for weaving patterns:
      FeldVectorChar / FeldVectorShort / FeldVectorBool -- 1D arrays with
      value-semantic assignment, file-format persistence and dynamic
      resizing;
      FeldGridChar                                      -- row-major 2D char
      grid with the same semantics.

    Every array is value-initialised on construction and written out as
    a binary hexdump inside a named @dbw3:file section.
*/
